...
int
define_space (int number_of_time_steps,
              int number_of_rows, int number_of_colums, int number_of_gscl)
{
...
double
get_space_height (int row, int column)
{
...
double
get_space_height (int t, int row, int column)
{
...
double
grain_percent (int t, int row, int column, int grainclass)
{
