...
extern "C"
{
#define  ANSI 1                 /* but leave LINT_ARGS and ANSI undefined */
#ifdef LINT_ARGS
  ...
  void chstwo (double *, double *, int, int, double *, double *, double *);
  ...
  void dfpmin (double *, int, double, int *, double *, double (*)(),
               void (*)());
  void difeq (int, int, int, int, int, int, int *, int, double **, double **);
  ...
  void simplx (double **, int, int, int, int, int, int *, int *, int *);
  ...
  void mrqcof (double *x, double *y, double *sig, int ndata, double *a,
               ...
               double *chisq, void (*funcs) (double, double *, double *,
                                             double *, int));
  ...
  double rtnewt (void (*funcd) (double, double *, double *), double x1,
