...
void del_lat(flowpath* current_flowpath,flowpath::iterator coastline_cell_index, double *discharge, long sim_time, double **sedflux_depo)

{
	...
	{	
		...
		double	waterdepth = get_topo_height(sim_time, coastline_cell_index->row,coastline_cell_index->col) - sealevel;
